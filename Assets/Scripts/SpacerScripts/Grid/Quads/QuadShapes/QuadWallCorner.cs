...
{
    public class QuadWallCorner : QuadData
    {
        public QuadWallCorner(MeshLayer quadLayer, QuadShape quadShape, Vector2Int quadTileAtlasCoord, Direction quadDirection, bool flipUV, bool isColorable, Color32 quadColor)
        {
