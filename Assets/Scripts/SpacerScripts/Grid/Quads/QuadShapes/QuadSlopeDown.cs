...
{
    public class QuadSlopeDown : QuadData
    {
        public QuadSlopeDown(MeshLayer quadLayer, QuadShape quadShape, Vector2Int quadTileAtlasCoord, Direction quadDirection, bool flipUV, bool isColorable, Color32 quadColor)
        {
